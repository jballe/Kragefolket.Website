...
define('WP_SITEURL', $website . 'wp');
define('WP_HOME', $website );
...
define('NONCE_KEY',        '<%= keys.NOUNCE_KEY %>');
...
/* development mode for JetPack plugin
define('JETPACK_DEV_DEBUG', <%= wpdebug %>);
